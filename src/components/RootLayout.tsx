...
function RootLayoutInner({ children }: { children: React.ReactNode }) {
	...
	return (
		<MotionConfig transition={shouldReduceMotion ? { duration: 0 } : undefined}>
			<header className="absolute inset-0 -top-2">
				<div
			...
			>
				...
				>
					<GridPattern
						className="absolute inset-x-0 -top-14 -z-10 h-[1000px] w-full fill-neutral-100 stroke-neutral-800/10 [mask-image:linear-gradient(to_bottom_left,white_40%,transparent_50%)]"
						yOffset={-96}
						interactive
					/>
