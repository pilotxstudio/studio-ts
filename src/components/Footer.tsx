	...
	return (
		<form className="max-w-sm">
			...
			<p className="mt-4 text-sm text-neutral-700">
				Get monthly case studies: what shipped, what failed, and what we changed
				next.
			</p>
	...
	return (
		<Container as="footer" className="mt-24 w-full sm:mt-32 lg:mt-40">
			<FadeIn>
				...
				<div className="mt-8 mb-20 flex flex-wrap items-end justify-between gap-x-6 gap-y-4 border-t border-neutral-950/10 pt-12">
					<Link href="/" aria-label="Home">
						<Logo className="h-8" fillOnHover />
					</Link>
					<p className="text-sm text-neutral-700">
						© PilotX Studio. {new Date().getFullYear()}
					</p>
				</div>
			</FadeIn>
		</Container>
