...
export const caseStudy = {
  ...
  testimonial: {
    ...
    content:
      'PilotX Studio did an amazing job building out our core blockchain infrastructure and I’m sure once PlaceboCoin rallies they’ll be able to finish the project.',
  },
}
